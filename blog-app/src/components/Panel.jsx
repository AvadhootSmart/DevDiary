      ...
      <div className="w-[20vw] z-0 h-screen fixed bg-[#111117] text-white">
        <div className="p-10 text-xl uppercase font-[Montserrat] font-light">
          ...
          <div className="mt-14 text-lg">
            <Link to="/Admin/ViewAll" className="flex items-center gap-4">
              <HiViewList /> View All
            </Link>
          </div>
          <div className="mt-14 text-lg">
            <Link to="/Admin/AddBlog" className="flex items-center gap-4">
              <IoMdAdd /> Create Blog
            </Link>
          </div>
          <div className="mt-14 text-lg">
            <Link to="/Admin/RemoveBlog" className="flex items-center gap-4">
              <MdDeleteForever /> Delete Blog
            </Link>
          </div>
          <div className="mt-14 text-lg">
            <Link to="/Admin/EditBlog" className="flex items-center gap-4">
              <MdEdit /> Edit Blog
            </Link>
          </div>
          <div className="mt-14 text-lg">
